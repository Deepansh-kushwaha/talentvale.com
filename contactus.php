...
<body>
    ...
    <h1 class="text-center"><b><strong>Contact us </strong></b></h1>
    <div class="container">
        <div class="container d-flex justify-content-center ">
<lottie-player src="https://assets3.lottiefiles.com/private_files/lf30_3lflolyo.json"  background="transparent"  
speed="1"  style="width: 300px; height: 300px;"  loop  autoplay></lottie-player>
        </div>
        <div class="container col-md-6 mb-4">
            <form class="d-flex flex-column  align-items-center " action="https://formsubmit.co/contact@talentvale.com" method="POST">  
            ...
            <div class="container form-group ">
                ...
                <textarea class="form-control css-input" name="message" id="querry"  placeholder="Write your querry here." required></textarea>
            </div>
